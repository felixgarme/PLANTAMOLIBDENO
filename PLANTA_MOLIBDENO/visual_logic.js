...
function vA4() {
  ...
  registerSetTimeout(1, function() {
    tweenCamera('A4', 'polySurface1107', 3, function() {}, 0);
...
function vB1() {
  ...
  registerSetTimeout(0.6, function() {
    tweenCamera('A3', 'pCube133.003', 0.5, function() {}, 0);
...
function vC1() {
  ...
  registerSetTimeout(1, function() {
    tweenCamera('C1', 'Reunion1', 1, function() {
      zoomCamera('Reunion1', 1, function() {
...
function vC2() {
  ...
  registerSetTimeout(1, function() {
    ...
    tweenCamera('C2', 'Reunion2', 1, function() {
      zoomCamera('Reunion2', 1, function() {
...
function vC3() {
  ...
  registerSetTimeout(1, function() {
    ...
    tweenCamera('C3', 'Reunion3', 1, function() {
      zoomCamera('Reunion3', 1, function() {
...
function vC4() {
  ...
  registerSetTimeout(1, function() {
    ...
    tweenCamera('C4', 'Reunion4', 1, function() {
      zoomCamera('Reunion4', 1, function() {
